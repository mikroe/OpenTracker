 ...
 //collect GPS data from serial port
  void collect_gps_data() { 
   ...
   // String data = "";    
    ...
    float flat, flon;
    unsigned long fix_age, time_gps, date, speed, course, alt;
    unsigned long chars;
         ...
         if(gps.encode(c))
          {
            ...
            gps.get_datetime(&date, &time_gps, &fix_age);          
            ...
            if((last_time_gps == time_gps) && (last_date_gps == date))
            {
