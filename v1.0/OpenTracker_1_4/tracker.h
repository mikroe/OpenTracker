  ...
  #define KEY "vZ23vO6xx4x"     //key for connection, will be sent with every data transmission
  ...
  #define HOSTNAME "opentracker.data.tigal.com"
  #define PROTO "TCP"
  #define PORT "80"
